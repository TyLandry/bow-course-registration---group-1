...
export default function SubmittedForms() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("submittedMessages");
    if (stored) {
  ...
  return (
    <div className="flex flex-col items-center gap-6 py-10">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">Manage Submitted messages from students.</p>
      </div>
        ...
        {selectedMessage && (
          <div className="flex items-center text-start flex-col mt-10">
            ...
            <div className="bg-gray-100 p-6 rounded-lg w-full max-w-2xl">
              <p>
                <span className="font-semibold">From:</span> {selectedMessage.fullName} (
              ...
              <p className="mt-1">{selectedMessage.fullMessage}</p>
              <button
